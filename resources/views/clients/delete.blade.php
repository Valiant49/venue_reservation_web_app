    ...
    @isset($client)
        <div class="align-center flex min-h-screen justify-center">
            <div class="m-auto w-full max-w-xl rounded-xl bg-white p-6 shadow-2xl">
                ...
                <h3 class="center mb-4 flex justify-center text-xl">Are you sure you want to remove this client?</h3>
                <div class="bg-surface-alt border-border-strong shadow-xs mb-4 overflow-hidden rounded-md border">
                    <table class="w-full text-left text-sm">
                        <tbody>
                            <tr>
                                <th class="bg-primary text-secondary w-1/3 px-4 py-3 text-right font-medium">Block No.</th>
                                <td class="text-body px-4 py-3">{{ $client->block_num }}</td>
                            </tr>
                            <tr>
                                <th class="bg-primary text-secondary w-1/3 px-4 py-3 text-right font-medium">Lot No.</th>
                                <td class="text-body px-4 py-3">{{ $client->lot_num }}</td>
                            </tr>
                            <tr>
                                <th class="bg-primary text-secondary w-1/3 px-4 py-3 text-right font-medium">Street No.</th>
                                <td class="text-body px-4 py-3">{{ $client->street_num }}</td>
                            </tr>
                            <tr>
                                <th class="bg-primary text-secondary w-1/3 px-4 py-3 text-right font-medium">Name</th>
                                <td class="text-body px-4 py-3">{{ $client->first_name }} {{ $client->middle_name }}
                                    {{ $client->last_name }}</td>
                            </tr>
                            <tr>
                                <th class="bg-primary text-secondary w-1/3 px-4 py-3 text-right font-medium">Contact No.
                                </th>
                                <td class="text-body px-4 py-3">{{ $client->contact_num }}</td>
                            </tr>
                            <tr>
                                <th class="bg-primary text-secondary w-1/3 px-4 py-3 text-right font-medium">Email</th>
                                <td class="text-body px-4 py-3">{{ $client->email }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
